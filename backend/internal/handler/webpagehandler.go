...
func UsagePage(c echo.Context, kube *kube.Kube) error {
	...
	jsonData, err := json.Marshal(status)
	if err != nil {
		return c.Render(http.StatusOK, "home.page2.gohtml", nil)
	}
	...
	return c.Render(http.StatusOK, "usage.page.gohtml", data)
}
